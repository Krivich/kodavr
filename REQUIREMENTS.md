...
- ✅ **KDV-A11Y-03**: No-navigation changes are announced: the gate→hall, gate→reception and "Copied ✓" transitions update an SSR-present `role="status"`/`aria-live` region, and the reception block is a named region. *(§6.6, §6.3)*
