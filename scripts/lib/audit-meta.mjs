/**
 * CONTRACT: scripts/lib/audit-meta.mjs
 ...
 *   ./audit-judge.mjs — JUDGE_SCHEMA, parseJudgeReply (the shared allowlist + parser)
 *   ./audit-trace.mjs — quoteMask (the deterministic non-LLM trace sanitizer)
 * INVARIANTS:
...
import { callAuditLLM } from './audit-llm.mjs';
import { JUDGE_SCHEMA, parseJudgeReply } from './audit-judge.mjs';
import { quoteMask } from './audit-trace.mjs';
