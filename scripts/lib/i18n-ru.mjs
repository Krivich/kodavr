...
export const RU = Object.freeze({
  ...
  HOME_EXPLAINER:
    'Kodavr — реестр неотполированных полевых отчётов: код, рабочие процессы и вынесенные уроки, упакованные так, чтобы ваш ИИ-агент мог прочитать их и адаптировать для вас. Сделать что-то стоит 1x усилий; упаковать это для других — 10x. Мы устраняем эту асимметрию.',
  HOME_HUMANS_LEAD:
