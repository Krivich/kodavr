/**
 * CONTRACT: scripts/lib/audit-policy.mjs
 ...
 * CONSUMES:
 *   ./audit-channel.mjs — validateChannelResult (the fail-visible channel schema)
 *   ./audit-forensic.mjs — buildForensicMap (the converged findings)
 * INVARIANTS:
 ...
 */
import { validateChannelResult } from './audit-channel.mjs';
import { buildForensicMap } from './audit-forensic.mjs';
