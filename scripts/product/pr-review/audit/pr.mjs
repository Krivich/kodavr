/**
 * CONTRACT: scripts/product/pr-review/audit/pr.mjs
 ...
 * CONSUMES:
 *   ./detectors.mjs — structuralChannel (Layer-1 over the PR patch text)
 *   ./envelope.mjs — checkDiffShape, checkAuthorSignals, evaluateEnvelope
 *   ./policy.mjs — evaluatePolicy
 *   ./report.mjs — renderAuditComment
 * INVARIANTS:
 ...
 */
import { checkDiffShape, checkAuthorSignals, evaluateEnvelope } from './envelope.mjs';
import { structuralChannel } from './detectors.mjs';
import { evaluatePolicy } from './policy.mjs';
import { renderAuditComment } from './report.mjs';
