/**
 * CONTRACT: scripts/product/pr-review/audit/llm/trace.mjs
 ...
 * CONSUMES:
 *   ../channel.mjs — makeChannelResult, makeSpan (the channel-output schema)
 * INVARIANTS:
 ...
 */
import { makeChannelResult, makeSpan } from '../channel.mjs';
