/**
 * CONTRACT: scripts/product/pr-review/audit/llm/llm-channels.mjs
 ...
 *   ./llm.mjs — providerFromEnv, withRetry (the provider and its backoff)
 *   ./judge.mjs — judgeChannel, judgeEnsembleChannel (Layer 4)
 *   ./trace.mjs — traceResidueChannel (Layer 5 deterministic)
 *   ./meta.mjs — metaReviewChannel (Layer 5 LLM witness)
 * INVARIANTS:
...
import { providerFromEnv, withRetry } from './llm.mjs';
import { judgeChannel, judgeEnsembleChannel } from './judge.mjs';
import { traceResidueChannel } from './trace.mjs';
import { metaReviewChannel } from './meta.mjs';
