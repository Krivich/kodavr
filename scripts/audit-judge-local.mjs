#!/usr/bin/env node
/**
 * CONTRACT: scripts/audit-judge-local.mjs
 ...
 *   ./lib/audit-llm.mjs — OPENCODE_MODEL, providerFromAuth, providerFromEnv, providerFromWorkflowConfig
 *   ./lib/audit-judge.mjs — judgeChannel
 *   ./lib/audit-trace.mjs — traceResidueChannel (Layer 5 deterministic residue)
 *   ./lib/audit-meta.mjs — metaReviewChannel (Layer 5 masked-trace meta-reviewer)
 * INVARIANTS:
...
// scripts/audit-judge-local.mjs — run the Layer-4 judge over OUR OWN dumps, locally.
...
} from './lib/audit-llm.mjs';
import { judgeChannel } from './lib/audit-judge.mjs';
import { traceResidueChannel } from './lib/audit-trace.mjs';
import { metaReviewChannel } from './lib/audit-meta.mjs';
