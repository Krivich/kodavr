#!/usr/bin/env node
/**
 * CONTRACT: scripts/audit-local.mjs
 ...
 *   ./lib/audit-local.mjs — TRUSTED_AUTHOR, auditDumps, summarizeRuns
 * INVARIANTS:
...
// scripts/audit-local.mjs — run the PR audit over OUR OWN dumps, locally.
...
import { TRUSTED_AUTHOR, auditDumps, summarizeRuns } from './lib/audit-local.mjs';
