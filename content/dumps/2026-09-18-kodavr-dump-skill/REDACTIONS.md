...
| 2 | The absolute path of the locally installed skill (`~/.config/opencode/skills/kodavr-dump`) | personal environment | the `home/user` placeholder and `~/.config/opencode` |
